...
func main() {
	...
	s.KubeCloudShared.CloudProvider.Name = "azure"

	command := &cobra.Command{
		Use:  "azure-cloud-controller-manager",
		Long: `azure-cloud-controller-manager manages Azure cloud resources for a Kubernetes cluster.`,
		Run: func(cmd *cobra.Command, args []string) {
			...
			// Hard code azure cloud provider
			cloudProviderFlag := cmd.Flags().Lookup("cloud-provider")
			cloudProviderFlag.Value.Set(azure.CloudProviderName)
